  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center w-full px-4 overflow-y-scroll no-scrollbar animate-fade">
      <div className="text-center w-full mt-4">
        <h1 className="text-4xl font-bold tracking-tight mb-4 animate-fade-down">
          Settings
        </h1>
      ...
      <Tabs className="mt-4 w-full sm:px-16 px-4" defaultValue="account">
        <TabsList className="grid grid-cols-3 mb-8">
          <TabsTrigger
            className="data-[state=active]:bg-foreground data-[state=active]:text-primary-foreground"
            value="account"
          >
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex sm:flex-row flex-col justify-between sm:items-center items-start">
                  <div>
                    <Label
                      htmlFor="username"
                      className="font-semibold tracking-tight text-md"
                    >
                      Username
              ...
              <div className="flex flex-col space-y-4">
                <div className="flex flex-row justify-between items-center">
                  ...
                  <Switch
                    ...
                    checked={privacy}
                    onCheckedChange={(checked) =>
                      handleSettingChange("privacy", setPrivacy, checked)
                    }
                  />
                </div>
                <div className="flex flex-row justify-between items-center">
                ...
                <div className="flex flex-row justify-between items-center">
                  ...
                  <Switch
                    ...
                    checked={analytics}
                    onCheckedChange={(checked) =>
                      handleSettingChange("analytics", setAnalytics, checked)
                    }
                  />
                </div>
